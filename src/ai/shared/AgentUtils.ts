...
export function getAgentActionUtilsRecord(agent?: TldrawAgent) {
	const object = {} as Record<string, AgentActionUtil<AgentAction>>
	for (const util of AGENT_ACTION_UTILS) {
		object[util.type] = new util(agent) as AgentActionUtil<AgentAction>
	}
	return object
}
